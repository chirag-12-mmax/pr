...
class CustomCountryCodeTextField extends StatefulWidget {
  ...
  const CustomCountryCodeTextField({
    Key? key,
  ...
  @override
  _CustomCountryCodeTextFieldState createState() =>
      _CustomCountryCodeTextFieldState();
}

class _CustomCountryCodeTextFieldState
    extends State<CustomCountryCodeTextField> {
          ...
          child: Padding(
            ...
            child: Row(
              ...
              children: <Widget>[
                ...
                Container(
                  height: 15, // Add a vertical divider
                  width: 1.5,
                  color:
                      PickColors.textFieldBorderColor, // Adjust color as needed
                ),
              ],
            ),
          ),

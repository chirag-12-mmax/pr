...
import 'package:shah_investment/payment_module/uip_app_model.dart';
...
class MerchantScreen extends State<MerchantApp> {
  ...
  void getInstalledUpiAppsForeOS() {
    if (Platform.isIOS) {
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            children: <Widget>[
              ...
              ElevatedButton(
                  onPressed: getInstalledApps, child: const Text('Get UPI Apps')),
              const SizedBox(width: 5.0),
              Visibility(
                  maintainSize: false,
                  maintainAnimation: false,
                      ...
                      children: <Widget>[
                        Expanded(
                            child: ElevatedButton(
                                ...
                                child: const Text('Get Package Signature'))),
                        const SizedBox(width: 5.0)
                      ])),
              Text("Result: \n $result")
            ],
